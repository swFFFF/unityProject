...
namespace XFABManager
{
    public class AssetTreeItem : TreeViewItem
    {
        ...
        public AssetTreeItem(FileInfo a,int depeth = 0) : base(a != null ? a.displayName.GetHashCode() : Random.Range(int.MinValue, int.MaxValue), depeth, a != null ? a.displayName : "failed")
        {
            fileInfo = a;
            if (a != null)
